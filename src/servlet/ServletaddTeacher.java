...
public class ServletaddTeacher extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(request.getParameter("teaNum").isEmpty()
				|| request.getParameter("teaName").isEmpty()
				|| request.getParameter("password").isEmpty()
				|| request.getParameter("teaSex").isEmpty()
				|| request.getParameter("teaAge").isEmpty()
				|| request.getParameter("teaCourse").isEmpty()
