...
CREATE TABLE `score` (
  ...
  `stu_num` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '瀛﹀彿',
...
CREATE TABLE `user` (
  ...
  `user_num` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '闁活潿鍔嶉崺娑氭嫻閿曗偓瑜?',
  `user_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '鐢ㄦ埛鍚?',
...
INSERT INTO `user` VALUES ('11', 'admin', 'admin', '123', '18179586325', '2');
